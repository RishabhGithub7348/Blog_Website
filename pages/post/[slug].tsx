    ...
    <main>
      ...
      />
        ...
        <label className="block mb-5">
            ...
            placeholder="John Applessed" type="text" />
        </label>
        <label className="block mb-5">
            ...
            <input
             ...
             className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring"
            placeholder="John Applessed" type="email" />
        </label>
        <label className="block mb-5">
            ...
            placeholder="John Applessed" rows={8} />
        </label>

        {/* error will return when field validation fail */}
    ...
    const query = `*[_type == "post" && slug.current == $slug][0]{
      ...
      'comments': *[ _type == 'comment' && references(^._id) && approved]
         ...
         return {
             ...
             revalidate: 60,  // after 1 minute , it will update the page or old cached version
         }
}
